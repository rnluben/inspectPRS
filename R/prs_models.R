...
# Precision recall curves
   ...
   ReturnList <- list(TidyOut=TidyOut,TidyCText=TidyCText, TidyDText=TidyDText, TidyQText=TidyQText, AUCLabel=AUCLabel, DelongPValue=DelongPValue, DelongROC1=DelongROC1, DelongROC2=DelongROC2, NCase=NCase,NControl=NControl, ROC_C=ROC_C,ROC_B=ROC_B,ModelBLabel=ModelBLabel,ModelCLabel=ModelCLabel,PRSdataB=PRSdataB,PRSdataC=PRSdataC,PRSdataD=PRSdataD, ModelB=ModelB,ModelC=ModelC,TidyC=TidyC)
   return(ReturnList)
}
